...
const CSS = `
  * { box-sizing: border-box; }
  ...
  @media print {
    ...
    /* A4 is 1122.5px tall at 96dpi, so the sheet's 1123px min-height overflows the
       page by half a pixel and spills a blank second page in browser print. Content
